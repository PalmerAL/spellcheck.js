...
var bannedStrings = ["lll", "uc ", "acc ", "ucc ", "ecc ", "ei", "ccy", "cci", "cce", "gea", "geu", "ich", "uch", "vv", "jj", "kk", "ww", "xx", "q", "v ", "mision", "toin", "aply", "akc", "hr", "xs", "i ", "u ", "v ", "j ", "ii", "aaa", "bbb", "ccc", "ddd", "eee", "fff", "ggg", "hhh", "lll", "mmm", "nnn", "ooo", "ppp", "rrr", "sss", "ttt", "uuu", "vvv", "yy", "zzz", "bl ", "cie", "btion", "bsion", "hng", "mx"];

var exceptions = ["which", "rich", "much", "such", "touch", "bachelor", "attach", "sandwich", "ostrich", "cheaply", "vein", "protein", "height", "weird"];
...
function checkSpelling(word) {
    ...
    if(getVowelRatio(word) > 0.19) { //words with little or no vowels likely aren't spelled correctly
    return correct;
    } else {
        return false;
    }
...
function getLinguisticMatch(word) {
    ...
    return linguisticMatch.toLowerCase();
}
...
function getBestReplacement(word) {
    ...
    dictionary.forEach(function(value) {
        ...
        if(tempdiff / patternMatch.length <= diff && patternMatch != word.toLowerCase()) {
